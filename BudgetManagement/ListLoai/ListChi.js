...
const ListChi = (props) => {
    ...
    var url = "http://192.168.2.140:8000/td_loaiChi"
    ...
    const renderContact = ({ item }) => {
        ...
        const chuyentrangEdit = () => {
            props.navigation.navigate('UpdateChi', { id: item.id, title: item.title, quantity: item.quantity, image: item.image });
        }
    ...
    const chuyenAdd = () => {
        props.navigation.navigate('AddChi');
    }
    const quoaylai = () => {
